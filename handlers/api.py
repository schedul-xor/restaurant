...
class IndexHandler(BaseHandler):
    ...
    def get(self):
        self.set_default_headers()
        self.write('''<h2>Line</h2><img src="'''+self.application.self_url+'''/line/qrcode"></img>
<ul>
<li><a href="'''+self.application.self_url+'''/line/qrcode">'''+self.application.self_url+'''/line/qrcode</a></li>
</ul>''')
        self.finish()
...
class DBRefreshHandler(BaseHandler):
    def get(self):
        self.write('''<body>
<p>Use <a href="'''+self.application.self_url+'''/dbrefresh2">/dbrefresh2</a> for version 2</p>
<form enctype="multipart/form-data" action="'''+self.application.self_url+'''/dbrefresh" method="POST">
...
class DBRefresh2Handler(BaseHandler):
    def get(self):
        self.write('''<body>
<form enctype="multipart/form-data" action="'''+self.application.self_url+'''/dbrefresh2" method="POST">
<input type="file" name="filearg"/>
<input type="submit" value="Submit"/>
</form>
</body>''')
...
class LogDBInitHandler(BaseHandler):
    def get(self):
        self.write('''<body>
<form action="'''+self.application.self_url+'''/log/dbinit" method="POST">
...
class LogHandler(BaseHandler):
    def get(self):
        self.write('''<body>
<h1>Log admin</h1>
<form action="'''+self.application.self_url+'''/log/dump_callback" method="POST">
<input type="submit" value="Export callback log"/>
</form>
<form action="'''+self.application.self_url+'''/log/dump_jump" method="POST">
...
<br/>
<br/>
<form action="'''+self.application.self_url+'''/log/delete" method="POST" style="background-color:#f99;color:#fff;">
<p>DANGER ZONE</p>
